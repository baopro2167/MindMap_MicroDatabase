    ...
    public class JwtMiddleware
    {
     ...
     string message
 )
        {
            ...
            {
                HttpStatusCode.Unauthorized => ApiResponse<object>.Unauthorized(message),
                HttpStatusCode.Forbidden => ApiResponse<object>.Forbidden(message),
                _ => ApiResponse<object>.Error(message)
            };
